 ...
 * @author Dell
 */
@WebServlet(name = "Quiz_QuestionServlet", urlPatterns = {"/Quiz_QuestionServlet"})
public class Quiz_QuestionServlet extends HttpServlet {
   ...
   public void quizData(HttpServletRequest req,HttpServletResponse res) throws IOException{
